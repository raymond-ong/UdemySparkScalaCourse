...
// ray: copy the access_log.txt from upper folder.
// Note: this will only process 1 file once.
// Paste in new file to update the numbers.
// Modifying a processed file does not work.
